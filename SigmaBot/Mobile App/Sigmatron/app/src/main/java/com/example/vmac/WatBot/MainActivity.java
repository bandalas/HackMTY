...
public class MainActivity extends AppCompatActivity {
    ...
    private void sendMessage() {
        ...
        service.setUsernameAndPassword("a24e3ce5-b110-4bd7-aa50-4f96be7e6584", "hlGH2th0xv27");
        MessageRequest newMessage = new MessageRequest.Builder().inputText(inputmessage).context(context).build();
        MessageResponse response = service.message("19a57598-bb5c-45ee-8999-bdb10f0232a0", newMessage).execute();
